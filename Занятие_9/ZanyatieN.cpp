...
void search_flight_by_name(airplane arr[], int size) {
    ...
    for (int i = 0; i < size; i++) {
        if (arr[i].arrive_point == point && arr[i].t_go.hour == hour && arr[i].t_go.min == min) {
            cout << "----------------" << endl;
            cout << "Город назначения: " << arr[i].arrive_point << "; Стоимость: " << arr[i].cost << "; Тип полета: " << arr[i].type_flight << endl;
            cout << "Время отправки: " << arr[i].t_go.hour << ":" << arr[i].t_go.min << endl;
            cout << "Время прибытия: " << arr[i].t_end.hour << ":" << arr[i].t_end.min << endl;
            cout << "Время в пути: " << arr[i].t_trip.hour << ":" << arr[i].t_trip.min << endl;
            cout << "----------------" << endl;
            break;
        }
    }
...
int main(){
    ...
    //
    // cout << "----------------" << endl;
    // cout << "Город назначения: " << airbus.arrive_point << "; Стоимость: " << airbus.cost << "; Тип полета: " << airbus.type_flight << endl;
    // cout << "Время отправки: " << airbus.t_go.hour << ":" << airbus.t_go.min << endl;
    // cout << "Время прибытия: " << airbus.t_end.hour << ":" << airbus.t_end.min << endl;
    // cout << "Время в пути: " << airbus.t_trip.hour << ":" << airbus.t_trip.min << endl;
    // cout << "----------------" << endl;
